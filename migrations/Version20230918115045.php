 ...
 */
final class Version20230918115045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE module (id INT AUTO_INCREMENT NOT NULL, programme_id INT NOT NULL, categorie_id INT NOT NULL, nom VARCHAR(50) NOT NULL, INDEX IDX_C24262862BB7AEE (programme_id), INDEX IDX_C242628BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE programme (id INT AUTO_INCREMENT NOT NULL, modules_id INT NOT NULL, sessions_id INT NOT NULL, nb_jours INT NOT NULL, INDEX IDX_3DDCB9FF60D6DC42 (modules_id), INDEX IDX_3DDCB9FFF17C4D8C (sessions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, programme_id INT NOT NULL, formation_id INT NOT NULL, nom VARCHAR(50) NOT NULL, places INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, INDEX IDX_D044D5D462BB7AEE (programme_id), INDEX IDX_D044D5D45200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stagiaire (id INT AUTO_INCREMENT NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, sexe VARCHAR(50) NOT NULL, date_naissance DATE NOT NULL, ville VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, telephone VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE programme ADD CONSTRAINT FK_3DDCB9FF60D6DC42 FOREIGN KEY (modules_id) REFERENCES module (id)');
